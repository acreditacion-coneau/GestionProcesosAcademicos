              ...
              {openCards.designaciones && (
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <a href="/ayudantes" className="bg-[#eef2c6]/30 border border-[#eef2c6] p-4 rounded-xl flex items-center justify-between hover:bg-[#eef2c6]/60 transition-colors">
                      <div>
                    ...
                    <a href="/adscriptos" className="bg-[#eef2c6]/30 border border-[#eef2c6] p-4 rounded-xl flex items-center justify-between hover:bg-[#eef2c6]/60 transition-colors">
                      <div>
